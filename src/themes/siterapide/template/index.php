...
<section id="h__intro">
	<div class="container">
		<?= displayContent(null, 'Un <span>site web</span> à votre image. <br>Simple, rapide & abordable!', null, null, [
			[
		...
		<div class="end">
			...
			<div class="after-image">
				<div class="left">
					<?= displayContent(null, 'Personnalisé pour vos besoins', null, '<p>Faites-vous découvrir par des centaines de clients potentiels avec une présences web forte et optimisée. Faire la promotion de votre entreprise n’aura jamais été aussi simple !</p>'); ?>
				</div>
				<div class="right">
					<?= displayContent(null, null, null, '<p>Optez pour un site web de calibre professionnel à une fraction du prix.</p>'); ?>
				</div>
			</div>
		</div>
	</div>
...
<section id="h__prices">
	<div class="container">
		<?= displayContent(null, 'Tarifs & forfaits', null, '<p>Peu importe vos besoins, nous avons la solution adaptée à votre entreprise. N’hésitez surtout pas à nous contacter si vous avez des questions.</p>', [
			[
				'text' => 'Débuter',
				'href' => '/debuter-mon-site/',
			]
		]); ?>
		<div class="list">
			<div class="item">
				<div class="thead">
					...
					<Contents
						...
						text='<p>Il s’agit d’un site web d’une page avec plusieurs sections établies selon vos besoins.</p>'
					/>
								...
								<div class="item">
									<ul>
										<li>
											...
											<span>Section supplémentaire&#8239;: 3$</span>
										</li>
										<li>
											<div class="arrow">
												<svg xmlns="http://www.w3.org/2000/svg"width="32" height="31.918" viewBox="0 0 32 31.918"><g><path d="M14.834.03C28.5-.764,37.013,14.565,28.742,25.577A16.018,16.018,0,0,1,.928,21.364C-2.608,11.513,4.373.637,14.834.03m.223,1.058A14.9,14.9,0,1,0,28.04,24.708c7.425-10.22-.456-24.3-12.983-23.62" transform="translate(0 0)" fill="#214cf3"/><path d="M163.276,200.222h0a.514.514,0,0,1-.012.712l-8.762,8.814c-.376.316-.529.485-.978.139l-4.931-4.93a.538.538,0,0,1,.64-.862l4.7,4.645,8.6-8.533a.514.514,0,0,1,.738.015" transform="translate(-140.129 -188.9)" fill="#214cf3"/></g></svg>
											</div>
											<span>Langue supplémentaire&#8239;: 8$</span>
										</li>
										<li>
											<div class="arrow">
												<svg xmlns="http://www.w3.org/2000/svg"width="32" height="31.918" viewBox="0 0 32 31.918"><g><path d="M14.834.03C28.5-.764,37.013,14.565,28.742,25.577A16.018,16.018,0,0,1,.928,21.364C-2.608,11.513,4.373.637,14.834.03m.223,1.058A14.9,14.9,0,1,0,28.04,24.708c7.425-10.22-.456-24.3-12.983-23.62" transform="translate(0 0)" fill="#214cf3"/><path d="M163.276,200.222h0a.514.514,0,0,1-.012.712l-8.762,8.814c-.376.316-.529.485-.978.139l-4.931-4.93a.538.538,0,0,1,.64-.862l4.7,4.645,8.6-8.533a.514.514,0,0,1,.738.015" transform="translate(-140.129 -188.9)" fill="#214cf3"/></g></svg>
			...
			<div class="item">
				<div class="thead">
					...
					<Contents
						titleTag='h3'
						title='Multi-pages'
						text='<p>Il s’agit d’un site web de plusieurs pages modulables sélectionnées selon les besoins de votre entreprise.</p>'
					/>
					<span>Voir les détails +</span>
				</div>
				<div class="tbody">
								...
								<div class="item">
									<ul>
										<li>
											...
											<span>Page supplémentaire&#8239;: 8$</span>
										</li>
										<li>
											<div class="arrow">
												<svg xmlns="http://www.w3.org/2000/svg"width="32" height="31.918" viewBox="0 0 32 31.918"><g><path d="M14.834.03C28.5-.764,37.013,14.565,28.742,25.577A16.018,16.018,0,0,1,.928,21.364C-2.608,11.513,4.373.637,14.834.03m.223,1.058A14.9,14.9,0,1,0,28.04,24.708c7.425-10.22-.456-24.3-12.983-23.62" transform="translate(0 0)" fill="#214cf3"/><path d="M163.276,200.222h0a.514.514,0,0,1-.012.712l-8.762,8.814c-.376.316-.529.485-.978.139l-4.931-4.93a.538.538,0,0,1,.64-.862l4.7,4.645,8.6-8.533a.514.514,0,0,1,.738.015" transform="translate(-140.129 -188.9)" fill="#214cf3"/></g></svg>
											</div>
											<span>Langue supplémentaire&#8239;: 15$</span>
										</li>
										<li>
											<div class="arrow">
												<svg xmlns="http://www.w3.org/2000/svg"width="32" height="31.918" viewBox="0 0 32 31.918"><g><path d="M14.834.03C28.5-.764,37.013,14.565,28.742,25.577A16.018,16.018,0,0,1,.928,21.364C-2.608,11.513,4.373.637,14.834.03m.223,1.058A14.9,14.9,0,1,0,28.04,24.708c7.425-10.22-.456-24.3-12.983-23.62" transform="translate(0 0)" fill="#214cf3"/><path d="M163.276,200.222h0a.514.514,0,0,1-.012.712l-8.762,8.814c-.376.316-.529.485-.978.139l-4.931-4.93a.538.538,0,0,1,.64-.862l4.7,4.645,8.6-8.533a.514.514,0,0,1,.738.015" transform="translate(-140.129 -188.9)" fill="#214cf3"/></g></svg>
			...
			<div class="item">
				<div class="thead">
					...
					<Contents
						...
						text='<p>Il s’agit d’un site web transactionnel vous permettant d’afficher et de vendre vos produits sans avoir à vous casser la tête.</p>'
					/>
			...
			<div class="item">
				<div class="thead">
					...
					<Contents
						titleTag='h3'
						title='Petit budget'
						text='<p>Il s’agit d’un site web d’une page de 4 sections dont 2 au choix.</p>'
					/>
					<span>Voir les détails +</span>
				</div>
				<div className="tbody">
...
<section id="h__benefits">
	<div class="container">
		<?= displayContent(null, 'Avantages <br>& inclusions', null, '<p>Tous nos clients bénéficient d’une panoplie d’avantages et d’inclusions afin qui favoriser le fonctionnement de leur marketing web.</p>', [
			[
				'text' => 'Débuter',
				'href' => '/debuter-mon-site/',
			]
...
<section id="h__sectors-activity">
	<div class="container">
		<Contents
		...
		<Button
			text='Débuter'
			to='/debuter-mon-site/'
			class='blue has-arrow'
		/>
	</div>
</section>
<section id="h__cta">
	<div class="container">
		<?= displayContent(null, 'Besoin <span>d\'informations</span> ?', null, '<p>Contactez-nous dès maintenant pour découvrir nos forfaits, poser vos questions ou échanger avec un de nos représentants pour débuter une analyse de vos besoins.</p>', [
			[
